...
class Tree:
    ...
    def is_height_balanced(self):
        ...
        return self.is_height_balanced_helper(self._root) > -1
        
    
    def is_height_balanced_helper(self, root):
        
        if root is None:
            return 0
        
        left_h = self.is_height_balanced_helper(root._left)
        
        if left_h == -1:
            return -1
        
        right_h = self.is_height_balanced_helper(root._right)
    ...
    def sum_of_leaves(self):
        ...
        '''
        # Task 2
        return self.sum_of_leaves_helper(self._root)
        
    def sum_of_leaves_helper(self, root):
        total = 0
        if root is None: 
            return
        if (root._left is None and root._right is None): 
            total += root._element
        if root._left:
            total += self.sum_of_leaves_helper(root._left)
        if root._right:
            total += self.sum_of_leaves_helper(root._right)
    ...
    def flip_tree(self, node = None):
        ...
        '''
        # Task 3
        return self.flip_tree_helper(self._root)
    
    def flip_tree_helper(self, root):
        if root == None:
            return root
        tmp = root._left
        root._left = self.flip_tree_helper(root._right)
        root._right = self.flip_tree_helper(tmp)
        return root
...
class BinarySearchTree(Tree):
    ...
    def iterative_search(self, node, v):
        ...
        @return: Return the node having value v, or last node searched
        '''
        # Task 6, modify the code below
        pass
...
def main():
    ...
    print("#-------------------------- Problem 2 sum_of_leaves tests... --------------------------")
    print(T.sum_of_leaves(), "    Expected result is 21")

    print("#-------------------------- Problem 3 flip_tree tests... --------------------------")
    T1.flip_tree()
    T.flip_tree()
    ...
    print("#-------------------------- Problem 4 build_expression_tree tests... --------------------------")
    ...
    print("#-------------------------- Problem 5 evaluate tests... --------------------------")
    ...
    print("#-------------------------- Problem 6 iterative_search tests... --------------------------")
    ...
    print("#-------------------------- Problem 7 find k-th largest tests... --------------------------")
    bst = BinarySearchTree()
    bst.insert(10)
    bst.insert(5)
    bst.insert(15)
