class Graph:
    ...
    def remove_vertex(self, v):
        ...
        @return: Nothing
        '''
        for i in list(self._outgoing.keys()):
            if i == v:
                del self._outgoing[i]
            
            elif i != v:
                for z in list(self._outgoing[i].keys()):
                    if z == v:
                        del self._outgoing[i][z]
                        
        for i in list(self._incoming.keys()):
            if i == v:
                del self._incoming[i]
            
            elif i != v:
                for z in list(self._incoming[i].keys()):
                    if z == v:
                        del self._incoming[i][z]
    ...
    def remove_edge(self, u, v):
        ...
        @return: Nothing
        '''
        for i in list(self._outgoing[u]):
            if i == v:
                del self._outgoing[u][v]
                
        for i in list(self._incoming[u]):
            if i == v:
                del self._incoming[u][v]
                
        for i in list(self._outgoing[v]):
            if i == u:
                del self._outgoing[v][u]
                
        for i in list(self._incoming[v]):
            if i == u:
